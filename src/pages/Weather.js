...
const Weather = () => {
    ...
    const chartOption = {
        ...
        series: [
            { name: 'Días de lluvia', type: 'bar', data: monthlyRainData.rainDays, itemStyle: { color: '#3b82f6', borderRadius: [4, 4, 0, 0] }, yAxisIndex: 0 },
            { name: 'Impacto producción', type: 'line', data: monthlyRainData.rainDays.map(d => d * IMPACT_PER_RAIN_DAY), smooth: true, lineStyle: { color: '#ef4444', width: 3 }, symbol: 'circle', yAxisIndex: 1, areaStyle: { opacity: 0.1, color: '#ef4444' } },
        ],
