...
const Risks = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "flex justify-between items-center mb-8", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold", children: "An\u00E1lisis de Riesgos & Monte Carlo" }), _jsx("p", { className: "text-muted-foreground", children: "Simulaci\u00F3n estoc\u00E1stica de escenarios financieros" })] }), _jsxs("button", { onClick: runSimulation, disabled: isSimulating, className: "flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg font-bold hover:scale-105 transition-all disabled:opacity-50", children: [_jsx(Play, { className: "w-5 h-5 fill-current" }), isSimulating ? 'Simulando...' : 'Ejecutar 3,000 Iteraciones'] })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [_jsxs("div", { className: "glass-card p-6 rounded-xl space-y-6", children: [_jsxs("h3", { className: "font-heading font-bold flex items-center gap-2 text-gradient", children: [_jsx(BarChart, { className: "w-5 h-5" }), " Par\u00E1metros"] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsxs("label", { className: "text-sm text-muted-foreground block mb-2", children: ["Volatilidad del Mercado (", volatility * 100, "%)"] }), _jsx("input", { type: "range", min: "0.05", max: "0.3", step: "0.01", value: volatility, onChange: (e) => setVolatility(parseFloat(e.target.value)), className: "w-full accent-primary" })] }), _jsx("div", { className: "p-4 bg-primary/5 border border-primary/20 rounded-lg", children: _jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-2", children: [_jsx(Info, { className: "w-4 h-4" }), " Las simulaciones se ejecutan en segundo plano utilizando Web Workers."] }) })] }), stats && (_jsxs("div", { className: "space-y-4 pt-4 border-t border-border", children: [_jsx("h4", { className: "text-sm font-bold uppercase tracking-wider text-muted-foreground", children: "Estad\u00EDsticas de VAN" }), _jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsxs("div", { className: "p-3 bg-card rounded-lg border border-border", children: [_jsx("p", { className: "text-xs text-muted-foreground", children: "Media (P50)" }), _jsxs("p", { className: "text-lg font-bold text-blue-400", children: ["$", (stats.p50 / 1000).toFixed(1), "k"] })] }), _jsxs("div", { className: "p-3 bg-card rounded-lg border border-border", children: [_jsx("p", { className: "text-xs text-muted-foreground", children: "Riesgo (P5)" }), _jsxs("p", { className: "text-lg font-bold text-red-400", children: ["$", (stats.p5 / 1000).toFixed(1), "k"] })] })] })] }))] }), _jsxs("div", { className: "lg:col-span-2 glass-card p-6 rounded-xl", children: [_jsxs("h3", { className: "font-heading font-bold mb-6 flex items-center gap-2 text-gradient", children: [_jsx(ShieldAlert, { className: "w-5 h-5" }), " Distribuci\u00F3n de Probabilidad del VAN"] }), _jsx("div", { className: "h-[400px]", children: stats ? (_jsx(ReactECharts, { option: distributionOption, style: { height: '100%' } })) : (_jsx("div", { className: "h-full flex items-center justify-center text-muted-foreground border-2 border-dashed border-border rounded-lg", children: "Haga clic en \"Ejecutar\" para visualizar la distribuci\u00F3n" })) })] }), _jsxs("div", { className: "lg:col-span-3 glass-card p-6 rounded-xl", children: [_jsx("h3", { className: "font-heading font-bold mb-6 text-gradient", children: "An\u00E1lisis de Sensibilidad (Tornado)" }), _jsx("div", { className: "h-[400px]", children: _jsx(ReactECharts, { option: tornadoOption, style: { height: '100%' } }) })] })] })] }));
};
