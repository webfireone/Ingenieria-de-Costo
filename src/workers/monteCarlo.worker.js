...
import { calculateNPV } from '../services/formulas';
/**
...
self.onmessage = (e) => {
    const { iterations, initialInvestment, monthlyRevenueBase, monthlyCostBase, durationMonths, discountRate, volatility } = e.data;
    const results = [];
