 ...
 */
export const calculateIRR = (cashFlows, guest = 0.1) => {
 ...
 */
export const calculateBreakEven = (fixedCosts, salePrice, variableCostPerM3) => {
 ...
 */
export const calculateOEE = (availability, // 0-1
performance, // 0-1
quality // 0-1
) => {
 ...
 * Total Cost per m3
 */
export const calculateUnitCost = (materials, operationalVariable, fixedCostsAllocated) => {
